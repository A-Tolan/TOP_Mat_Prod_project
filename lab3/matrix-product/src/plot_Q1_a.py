...
plt.title("Performance du produit matriciel naïf (M=N=K=512)")
plt.grid(True)
plt.legend()
plt.xlim(left=0)
plt.ylim(bottom=0)
plt.tight_layout()
plt.savefig("performance_runtime_naive_512.png")
plt.show()
...
plt.title("Temps d'exécution vs Threads (M=N=K=512, code naïf)")
plt.grid(True)
plt.legend()
plt.xlim(left=0)
plt.ylim(bottom=0)
plt.tight_layout()
plt.savefig("runtime_vs_threads_naive_512.png")
plt.show()
...
plt.xlabel("Nombre de threads")
plt.ylabel("Speedup")
plt.title("Strong Scaling: Speedup vs Threads (M=N=K=512, code naïf)")
plt.grid(True)
plt.legend()
plt.xlim(left=0)
plt.ylim(0, 2)
plt.tight_layout()
plt.savefig("strong_scaling_speedup_naive_512.png")
plt.show()
